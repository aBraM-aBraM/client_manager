...
abstract class AppLocalizations {
  ...
  /// No description provided for @treatmentHaircut.
  ///
  /// In en, this message translates to:
  /// **'Haircut'**
  String get treatmentHaircut;

  /// No description provided for @treatmentColoring.
  ///
  /// In en, this message translates to:
  /// **'Hair Coloring'**
  String get treatmentColoring;

  /// No description provided for @treatmentProduct.
  ///
  /// In en, this message translates to:
  /// **'Hair Product'**
  ...
  /// In en, this message translates to:
  /// **'No next appointment'**
  String get noNextAppointment;

  /// No description provided for @pickLastAppointment.
  ///
  /// In en, this message translates to:
  /// **'Pick Last Appointment'**
  String get pickLastAppointment;

  /// No description provided for @pickNextAppointment.
  ///
  /// In en, this message translates to:
  /// **'Pick Next Appointment'**
